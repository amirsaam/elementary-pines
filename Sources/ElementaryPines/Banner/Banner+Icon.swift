...
/// ```
///
/// `.wand` (the default) inlines the exact magic-wand SVG from the official
/// Pines banner example. `.kind(_)` uses one of the built-in `PinesIconKind`
...
public enum PinesBannerIcon: Sendable {
    /// The official magic-wand SVG from the Pines banner docs (the default).
    case wand
