...
- `ElementaryPines` — 27 UI components (Accordion, Alert, Badge, Banner, Breadcrumb, Button, Card, Checkbox, DatePicker, Dropdown, Icons, Input, MenuBar, Modal, Popover, Progress, Quote, RadioGroup, RangeSlider, Rating, Select, SlideOver, Switch, Tabs, Textarea, Toast, Tooltip) + `PinesColor` color system
...
- One directory per component: Accordion, Alert, Badge, Banner, Breadcrumb, Button, Card, Checkbox, DatePicker, Dropdown, Icons, Input, MenuBar, Modal, Popover, Progress, Quote, RadioGroup, RangeSlider, Rating, Select, SlideOver, Switch, Tabs, Textarea, Toast, Tooltip
