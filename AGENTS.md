...
- `ElementaryPines` — 23 UI components (Accordion, Alert, Badge, Banner, Breadcrumb, Button, Card, Checkbox, DatePicker, Dropdown, Icons, Input, Progress, Quote, RadioGroup, RangeSlider, Rating, Select, Switch, Tabs, Textarea, Toast, Tooltip) + `PinesColor` color system
...
- One directory per component: Accordion, Alert, Badge, Banner, Breadcrumb, Button, Card, Checkbox, DatePicker, Dropdown, Icons, Input, Progress, Quote, RadioGroup, RangeSlider, Rating, Select, Switch, Tabs, Textarea, Toast, Tooltip
